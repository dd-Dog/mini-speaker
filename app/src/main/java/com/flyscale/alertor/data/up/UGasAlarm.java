...
/**
 * @author 高鹤泉
 * @TIME 2020/6/12 13:47
 * @DESCRIPTION 2.18煤气报警
 * 2.18.1说明
 ...
 */
public class UGasAlarm extends UDefaultAlarm {

    public UGasAlarm(@noteSendCount int sendCount) {
        super(sendCount);
    }

    @Override
    public int getType() {
        return TYPE_GAS_ALARM_U;
    }
}
